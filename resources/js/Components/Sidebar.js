...
export default function Sidebar(props) {
    ...
    return (
        ...
        <div className={props.showingNavigationDropdown ? "w-1/2 md:w-1/3 lg:w-64 md:left-0 min-h-screen lg:block bg-gray-100 border-r z-30" : "w-1/2 md:w-1/3 lg:w-64 md:left-0 min-h-screen lg:block bg-gray-100 border-r z-30 hidden"} id="main-nav">
            <div className="w-full h-23 border-b flex px-4 items-center mb-8">
            ...
            <div className="mb-4 px-4">
                <p className="mt-4 pl-4 text-sm font-semibold mb-1">MAIN</p>
                <SidebarLink href={route('dashboard')} active={route().current('dashboard')} className="w-full flex items-center text-blue-400 h-10 pl-4 bg-gray-200 hover:bg-gray-200 rounded-lg cursor-pointer">
                ...
                <SidebarLink href={route('profile.index')} active={route().current('profile.index')} className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                    <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                        <path d="M17.431,2.156h-3.715c-0.228,0-0.413,0.186-0.413,0.413v6.973h-2.89V6.687c0-0.229-0.186-0.413-0.413-0.413H6.285c-0.228,0-0.413,0.184-0.413,0.413v6.388H2.569c-0.227,0-0.413,0.187-0.413,0.413v3.942c0,0.228,0.186,0.413,0.413,0.413h14.862c0.228,0,0.413-0.186,0.413-0.413V2.569C17.844,2.342,17.658,2.156,17.431,2.156 M5.872,17.019h-2.89v-3.117h2.89V17.019zM9.587,17.019h-2.89V7.1h2.89V17.019z M13.303,17.019h-2.89v-6.651h2.89V17.019z M17.019,17.019h-2.891V2.982h2.891V17.019z"></path>
                    </svg>
                    <span className="text-gray-700">My Profile</span>
                </SidebarLink>
                <SidebarLink href={route('calendar.index')} active={route().current('calendar.index')} className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
                <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
