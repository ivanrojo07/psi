...
export default function Sidebar(props) {
    ...
    return (
        ...
        <div className={props.showingNavigationDropdown ? "w-1/2 md:w-1/3 lg:w-64 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" : "w-1/2 md:w-1/3 lg:w-64 md:left-0 h-screen lg:block bg-gray-100 border-r z-30 hidden"} id="main-nav">
